...
ThemeData MyTheme() {
  return ThemeData(
    ...
    colorScheme: const ColorScheme(
      ...
      secondary: Color(0xFF0D1426),                                 // Text Default
      secondaryVariant: Color(0xFF4A4E5D),                          // Text Subdued
    ...
    primaryIconTheme: IconThemeData(color: Color(0xFF515B7B),),     // Default Icons
    accentIconTheme:   IconThemeData(color:Color(0xFF98A2B3),),     // Subdued Icons
